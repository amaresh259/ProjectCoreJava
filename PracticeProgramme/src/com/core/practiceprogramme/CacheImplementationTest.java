...
public class CacheImplementationTest {
    ...
    public static void main(String[] args) {
        ...
        CacheImplementationTest crunchifyCache = new CacheImplementationTest();
    ...
    private void crunchifyTestAddRemoveObjects() {
        ...
        // maxItems = 6
        CacheImplementation<String, String> cache = new CacheImplementation<String, String>(6);
        ...
        System.out.println("Print the values in cache ::"+cache.key("IBM"));
        System.out.println("Print the values in cache 2 ::"+cache.key("Hari"));
    ...
    /*private void crunchifyTestAddRemoveObjects() {
        ...
        // crunchifyTimerInterval = 500 seconds
        // maxItems = 6
        CacheImplementation<String, String> cache = new CacheImplementation<String, String>(200, 500, 6);
    ...
    private void crunchifyTestExpiredCacheObjects() throws InterruptedException {
        ...
        // maxItems = 10
        CacheImplementation<String, String> cache = new CacheImplementation<String, String>(1, 1, 10);
    ...
    /*private void crunchifyTestObjectsCleanupTime() throws InterruptedException {
        ...
        CacheImplementation<String, String> cache = new CacheImplementation<String, String>(100, 100, 500000);
